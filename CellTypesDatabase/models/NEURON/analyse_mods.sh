...
pynml-modchananalysis Ca_LVA -stepV 5 -temperature 34
pynml-modchananalysis Ca_HVA -stepV 5 -temperature 34

#pynml-modchananalysis NaTa -stepV 5 -temperature 6.3
#pynml-modchananalysis NaTs -stepV 5 -temperature 6.3
...
#pynml-modchananalysis Kd -stepV 5 -temperature 6.3
#pynml-modchananalysis Kv2like -stepV 5 -temperature 6.3
...
#pynml-modchananalysis Im_v2 -stepV 5 -temperature 6.3

#pynml-modchananalysis SK -stepV 5 -temperature 6.3

# Kinetic scheme based...
#pynml-modchananalysis NaV -stepV 5 -temperature 6.3
