...
ALL_ACTIVE_MODEL_IDS = [497233223] #497233223 is all-active
    ...
    for neuronal_model_id in neuronal_model_ids:
        ...
        try:
            ...
            if os.path.isfile(nwb_file):
                ...
                metadata['AIBS:aibs_dendrite_type'] = _format(h5file.root.general.aibs_dendrite_type.read())
                metadata['AIBS:aibs_cre_line'] = _format(h5file.root.general.aibs_cre_line.read())
                metadata['AIBS:aibs_specimen_id'] = _format(h5file.root.general.aibs_specimen_id.read())
                metadata['AIBS:aibs_specimen_name'] = _format(h5file.root.general.aibs_specimen_name.read())
                metadata['AIBS:intracellular_ephys:Electrode 1:location'] = _format(h5file.root.general.intracellular_ephys._v_children['Electrode 1'].location.read())
                metadata['AIBS:session_id'] = _format(h5file.root.general.session_id.read())
                metadata['AIBS:subject:age'] = _format(h5file.root.general.subject.age.read())
                metadata['AIBS:subject:description'] = _format(h5file.root.general.subject.description.read())
                metadata['AIBS:subject:genotype'] = _format(h5file.root.general.subject.genotype.read())
                metadata['AIBS:subject:sex'] = _format(h5file.root.general.subject.sex.read())
                metadata['AIBS:subject:species'] = _format(h5file.root.general.subject.species.read())
            else:
